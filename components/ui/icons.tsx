...
function IconWeb3GPT({ className, ...props }: React.ComponentProps<"svg">) {
	return (
		...
		>
			<title>Web3GPT</title>
			<rect width="36" height="8" fill="purple" />
			<rect x="36" y="16.0001" width="32" height="8" fill="purple" />
			<rect x="19.9999" y="32" width="32" height="8" fill="purple" />
			<rect x="48" width="36" height="8" fill="purple" />
		</svg>
	);
}
