...
- **Description**: Specialized agent for Solana smart contract development and deployment.
- **Capabilities**:
  - Generate and deploy Solana programs in Rust
  - Create SPL tokens and NFTs
  - Handle program upgrades and migrations
  - Integrate with Anchor framework
  - Manage program derived addresses (PDAs)
